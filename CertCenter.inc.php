<?php namespace CertCenter {
	...
	class RESTful {
		...
		private $__MethodInfo = Array(
			...
			'GetUser'=>				Array('http_method'=>'GET',
											'path_parameter'=>'UserNameOrUserId'),
			'UpdateUser'=>			Array('http_method'=>'POST',
											'path_parameter'=>'UserNameOrUserId'),
			'DeleteUser'=>			Array('http_method'=>'DELETE',
											'path_parameter'=>'UserNameOrUserId'),
			'GetCustomers'=>		Array('http_method'=>'GET'),
			'GetCustomer'=>			Array('http_method'=>'GET',
											'path_parameter'=>'UserNameOrUserId'),
			'VulnerabiltyAssessment'=>Array('http_method'=>'POST'),
			'Order'=>				Array('http_method'=>'POST'),
			'CancelOrder'=>			Array('http_method'=>'DELETE',
											'path_parameter'=>'CertCenterOrderID'),
			'Revoke'=>				Array('http_method'=>'DELETE',
											'path_parameter'=>'CertCenterOrderID'),
			...
			'GetOrder'=>			Array('http_method'=>'GET',
											'path_parameter'=>'CertCenterOrderID'),
			'Reissue'=>				Array('http_method'=>'POST'),
			'UpdateApproverEmail'=>	Array('http_method'=>'PUT',
											'path_parameter'=>'CertCenterOrderID',
											'query_parameter'=>'ApproverEmail'),
			'ResendApproverEmail'=>	Array('http_method'=>'POST',
											'path_parameter'=>'CertCenterOrderID'),
